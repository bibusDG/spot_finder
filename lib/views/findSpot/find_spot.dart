                ...
                return Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          detailedPageController.spotIndex.value = index;
                                  ...
                                  if (controller.spotList[index].spotPhotos?.length != null) ...[
                                    ...
                                    SizedBox(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          child: CircleAvatar(
                                            radius:60,
                                            backgroundImage: Image.memory(base64Decode(controller.spotList[index].spotPhotos![0])).image),
                                        )),
                                    RatingBarIndicator(
                                      ...
                                      children: [
                                        ...
                                        ValueBuilder<bool?>(
                                            ...
                                            builder: (value, updateFn) {
                                              return Switch(
                                                value: value!,
                                                onChanged: (newValue) => updateFn(controller.generalSwitch.value),
                                                // same signature! you could use ( newValue ) => updateFn( newValue )
                                              );
                                            },
                                            // if you need to call something outside the builder method.
                                            onUpdate: (value) async {
                                              if(switchMarker==true && value==false && riderSwitch.read(index.toString())==false){
                                                Get.defaultDialog(title: 'Seriously...?', content: Text('You are riding somewhere else!!!'));
                                              }
                                              ...
                                              if (controller.spotList[index].spotRiders! >= 0 && value == true) {
                                                FirebaseServices().updateSpot(
                                                    index, {'spotRiders': controller.spotList[index].spotRiders! + 1});
                                                controller.generalSwitch.value = false;
                                                switchMarker = true;
                                              }
                                              if (controller.spotList[index].spotRiders! > 0 && value == false) {
                                                FirebaseServices().updateSpot(
                                                    index, {'spotRiders': controller.spotList[index].spotRiders! - 1});
                                                controller.generalSwitch.value=true;
                                                switchMarker=false;
                                              }
                                            },
                                            onDispose: () {
