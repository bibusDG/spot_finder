...
import 'package:skate_spot_finder/firebase_options.dart';
...
import 'package:skate_spot_finder/views/spot_on_map/spot_on_map.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/spotOnMap', page:()=>SpotOnMap()),
      ],
    );
  }
}
